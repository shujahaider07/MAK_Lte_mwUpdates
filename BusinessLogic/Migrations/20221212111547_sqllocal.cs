...
{
    public partial class sqllocal : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PageImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Type = table.Column<int>(type: "int", nullable: false),
                    InQueueName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OutQueue = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LogFilePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LogFilePattern = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LogFileSize = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
